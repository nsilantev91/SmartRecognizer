...
namespace AForge.WindowsForms
{
    ...
    /*public class GenerateImage
    {
        ...
        private System.Drawing.Point GetLeftUpperPoint()
        {
        ...
        private System.Drawing.Point GetRightDownPoint()
        {
            int x = 100 + FigureSize / 2 + rand.Next(-FigureSizeGitter / 2, FigureSizeGitter / 2);
            int y = 100 + FigureSize / 2 + rand.Next(-FigureSizeGitter / 2, FigureSizeGitter / 2);
            return new System.Drawing.Point(x, y);
        ...
        private System.Drawing.Point GetCenterPoint()
        {
        ...
        public bool create_triangle()
        {
            ...
            System.Drawing.Point leftUpper = GetLeftUpperPoint();
            System.Drawing.Point downLeft = GetRightDownPoint();
        ...
        public bool create_circle()
        {
            ...
            System.Drawing.Point center = GetCenterPoint();

            int radius = rand.Next(50, 65);

            for (double t = 0; t < 2 * System.Math.PI; t += 0.01)
            {
                double x = center.X + radius * System.Math.Cos(t);
                double y = center.Y + radius * System.Math.Sin(t);
        ...
        public bool create_sin()
        {
            ...
            {
                double y = System.Math.Round(centerY + amp * System.Math.Sin(sx * x));
                img[(int)x, (int)y] = true;
            }
